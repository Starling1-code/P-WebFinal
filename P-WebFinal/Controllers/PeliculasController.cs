...
using P_WebFinal.Models;

namespace P_WebFinal.Controllers
{
    public class PeliculasController : Controller
    {
        private readonly CineVirtualContext _context;

        public PeliculasController(CineVirtualContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CineVirtualContext.Peliculas'  is null.");
            }
            var pelicula = await _context.Peliculas.FindAsync(id);
            if (pelicula != null)
            {
        ...
        {
          return (_context.Peliculas?.Any(e => e.IdP == id)).GetValueOrDefault();
        }
    }
}
